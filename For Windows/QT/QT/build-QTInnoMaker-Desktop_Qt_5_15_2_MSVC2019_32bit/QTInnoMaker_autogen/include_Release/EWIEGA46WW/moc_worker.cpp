...
QT_MOC_LITERAL(5, 27, 4), // "recv"
QT_MOC_LITERAL(6, 32, 7), // "Message"
QT_MOC_LITERAL(7, 40, 7) // "process"

    },
    "Worker\0finished\0\0error\0err\0recv\0Message\0"
    "process"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->recv((*reinterpret_cast< Message(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Worker::*)(Message );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::recv)) {
                *result = 2;
                return;
            }
        }
